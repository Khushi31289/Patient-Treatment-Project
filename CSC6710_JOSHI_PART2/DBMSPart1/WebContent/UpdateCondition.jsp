...
<title>Update new condition for a patient</title>
<style type="text/css">
	div{
		padding-top: 15px;
	}
...
<body id="myBody" onload="">
	<h1>Update condition for a Patient</h1>
	<form action="UpdatePatientConditions" method="post" id="frmUpdate"> 
		<div>
			<label>Condition Id<sup>*</sup>:</label>
			&nbsp;
			<select id = "selPid" name = "selPid" required="required"  onchange="GetConditionByAjax();"> 
