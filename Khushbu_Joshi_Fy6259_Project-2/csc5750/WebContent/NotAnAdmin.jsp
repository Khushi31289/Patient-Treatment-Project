      ...
      <div class="row">
        <div class="offset3 span6">
            ...
            <form class="form-horizontal" >
              <fieldset>
                <legend>Access Restricted to Administrator only</legend>
                <div id="MsgDiv">
					 <p class="help-block fontRed">Dear User, the area that you are trying to access is restriced to Administrator of the Website only.</p>
				</div>
				<br>
              </fieldset>
            </form>
