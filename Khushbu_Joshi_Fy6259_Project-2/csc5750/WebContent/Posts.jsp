  ...
  <body>
    ...
    %>
		<div id="<%=id %>">
			...
			%>
			<br><a href="<%=request.getContextPath()%>/Comment.jsp?postid=<%=id%>">Comment</a>
				<% if(removeLink){ %> | <a href="<%=request.getContextPath()%>/fy6259/project2/Posts?postid=<%=id%>&remove=yes">Remove</a> <%} %>
		</div>
		<hr>
	<% 
